  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/mi-redmi-note-7s.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Redmi Note 7S</h3>
              <h4>₹10999</h4>
              <pre class="card-text"><ul><li>4 GB RAM , 64 GB ROM , Expandable Upto 256 GB , </li>
<li>AI Dual Rear Camera 16.0 cm (6.3 inch) FHD+ Display , 13 MP AI Front Camera</li>
<li>Package includes:Handset, Charging Cable, SIM Ejector Tool, Warranty Card, Manual, Soft Protective Case, Adapter</li>
<li>48MP and 5MP ,13MP Front Camera , Super Low-light (Night Photography)</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=12&&num=
