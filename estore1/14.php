  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/samsung-galaxy-m30.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Samsung Galaxy M30</h3>
              <h4>₹11490</h4>
              <pre class="card-text"><ul><li>13 MP + 5 MP + 5 MP Triple rear camera | 16MP front facing camera</li>
...
<li>5000mAH lithium-ion battery with 3x fast charge | 15W Type-C fast charger in the box ; USB Version: USB 2.0 ; Bluetooth: v5.0</li>
<li>Box also includes: Handset, Travel Adapter, USB Cable, Ejection Pin and User Manual</li></ul>
</pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=14&&num=
