  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/samsung-galaxy-a70s.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Samsung Galaxy A70s</h3>
              <h4>₹28999</h4>
              <pre class="card-text"><ul><li>64+5+8MP triple rear camera with f1.8, f2.2 wide angle and f2.2 with flash | 32MP front camera with f2.0</li>
<li>17.03 centimeters (6.7-inch) FHD+ multi-touch capacitive touchscreen with 1080 x 2400 pixels resolution | 16M color support</li>
<li>Memory, Storage & SIM: 6GB RAM | 128GB internal memory expandable up to 512GB | Dual SIM (nano+nano) dual-standby (4G+4G)</li>
<li>Android Pie v9.0 operating system with 2.7GHz Qualcomm SM6150 octa core processor</li>
<li>4500mAH lithium-ion battery with type-c fast charging | 25W charger in the box</li>
<li>Box also includes: Earphone, travel adapter, USB cable and user manual</li></ul></pre>
              <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=13&&num=
