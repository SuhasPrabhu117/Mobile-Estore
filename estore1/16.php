  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/product-7.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Iphone 7</h3>
              <h4>₹30000</h4>
              <pre class="card-text"><ul><li>4.7-inch Retina HD display</li>
<li>IP67 water and dust resistant (maximum depth of 1 meter up to 30 minutes)</li>
<li>12MP camera and 4K video</li>
<li>7MP FaceTime HD camera with Retina Flash</li>
<li>Touch ID for secure authentication</li>
<li>A10 Fusion chip</li>
<li>iOS 12 with Screen Time, Group FaceTime, and even faster performance</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=16&&num=
