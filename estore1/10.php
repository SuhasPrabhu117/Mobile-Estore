  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/mi-a3.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Mi A3</h3>
              <h4>₹12990</h4>
              <pre class="card-text"><ul><li>48+8+2MP AI triple rear camera | 32MP front camera</li>
<li>15.46 centimeters (6.088-inch) AMOLED multi-touch capacitive touchscreen with 1520 x 720 pixels resolution,</li>
<li>Memory, Storage & SIM: 4GB RAM | 64GB internal memory expandable up to 256GB | Dual SIM (nano+nano) dual-standby (4G+4G)</li>
<li>Android Pie v9.0 operating system with 2.0GHz Qualcomm Snapdragon 665 octa core processor, Adreno 610 GPU</li>
<li>4030mAH lithium-ion battery, AI Scene detection: Detects up to 12 different scenes ;</li>
<li>Supports Quick Charge 3.0 Technology and 18W Fast Charge ; In-box 10W charger ; Type-C charging port ;</li>
<li>Box also includes: Power adapter, USB cable, warranty card, user guide, SIM tray ejection tool and back cover</li>
</ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=10&&num=
