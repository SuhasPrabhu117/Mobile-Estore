  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/samsung-galaxy-a50s.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Samsung Galaxy A50s</h3>
              <h4>₹20999</h4>
              <pre class="card-text"><ul><li>48+5+8MP triple rear camera with F2.2, 2.2 and 2.2 aperture | 32MP front camera</li>
<li>16.21 centimeters (6.4-inch) super amoled V FHD+ resolution display with 2340 x 1080 pixels resolution | 16M color support</li>
<li>Memory, Storage & SIM: 6GB RAM | 128GB internal memory expandable up to 512GB | Dual SIM dual-standby (4G+4G)</li>
<li>Android v9 Pie operating system with 2.3GHz + 1.7GHz Exynos 9611 octa core processor</li>
<li>4000mAH lithium-ion battery</li>
<li>Box also Includes: Earphones, travel adapter, USB cable, ejection pin and user manual</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=15&&num=
