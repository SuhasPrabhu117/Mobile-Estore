  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/product-4.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">HTC 10 - White</h3>
              <h4>₹8000</h4>
              <pre class="card-text"><ul><li>Qualcomm MSM8996 Snapdragon 820 Chipset,Dual-core 2.15 GHz Kryo & dual-core 1.6 GHz Kryo CPU</li>
<li>Next Generation ultra vivid 2K display,Super LCD5 capacitive touchscreen, 16M colors,</li>
<li>5.2 inches (71.1% screen-to-body ratio),1440 x 2560 pixels (565 ppi pixel density),Corning Gorilla Glass 4 - HTC Sense UI</li>
<li>Primary Camera 12 MP, f/1.8, 26mm, OIS, laser autofocus,,Video Camera 2160p@30fps, 720p@120fps, HDR, stereo sound rec</li>
<li>Secondary Camera 5 MP, f/1.8, 23mm, OIS, autofocus, 1.34 µm pixel size, 1080p, HDR</li>
<li>Non-removable Li-Ion 3000 mAh battery.Fast battery charging: 50% in 30 min (Quick Charge 3.0)</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=4&&num=
