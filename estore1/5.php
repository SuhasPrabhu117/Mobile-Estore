  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/product-5.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">HTC Desire 626s</h3>
              <h4>₹24000</h4>
              <pre class="card-text"><ul><li>This Mobile is not Dual SIM, It is Single SIM mobile which supports both CDMA (upto 3G Speed) & GSM (upto 2G Speed) network.</li>
<li>Qualcomm Snapdragon 210, Quad-core 4 x 1.1 GHz Processor with 1.5 GB of RAM</li>
<li>Featuring an expandable memory of up to 200GB (MicroSD Card Require),</li>
<li>Android 5.1 Lollipop OS // 8.0MP Rear-Facing Camera // 8GB Internal Memory</li>
<li>5" HD Touchscreen; Large, bright display with 720p resolution lets you view texts and videos and play games in clear detail.</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=5&&num=
