  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/product-6.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Iphone 6</h3>
              <h4>₹17000</h4>
              <pre class="card-text"><ul><li>Camera: 8 MP Rear camera with Dual tone LED flash | 1.2 MP front camera</li>
<li>Display: 11.93 centimeters (4.7-inch) HD display capacitive touchscreen with 1334x750 pixels</li>
<li>Memory, Storage & SIM: 1GB RAM | 32GB storage | Single nano SIM</li>
<li>Operating System and Processor: iOS v8 operating system with 1.4GHz Apple A8 processor</li>
<li>Battery: 1810 mAH lithium ion battery providing talk-time of 14 hours on 3G networks with stand by upto 240 hours</li>
<li>Warranty: 1 year manufacturer warranty for device and in-box accessories including batteries from the date of purchase</li>
<li>Included in box: Charger, Earpods, Lightning to USB Cable</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=6&&num=
