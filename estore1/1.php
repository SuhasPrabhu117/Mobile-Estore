  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/product-1.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Google Pixel - Black</h3>
              <h4>₹40000</h4>
<pre class="card-text">
  <ul>
<li>12.3MP primary camera with phase detection autofocus (PDAF), laser detection autofocus (LDAF),</li>
<li>4K video capture, HD and full HD slow motion video and 8MP front facing camera</li>
<li>13.97 centimeters (5.5-inch) AMOLED display with 2560 x 1440 pixels resolution and 534 ppi pixel density</li>
<li>3450 mAH lithium-ion battery providing talk-time of 32 hours and standby time of 552 hours</li>
</ul></pre>
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=1&&num=
