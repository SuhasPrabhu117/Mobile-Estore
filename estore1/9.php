  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/mi-redmi-note-7-pro.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Redmi Note 7 Pro</h3>
              <h4>₹11999</h4>
              <pre class="card-text"><ul><li>6 GB RAM | 128 GB ROM | Expandable Upto 256 GB</li>
<li>16.0 cm (6.3 inch) FHD+ Display 48MP + 5MP | 13MP Front Camera</li>
<li>4000 mAh Li-polymer Battery</li>
<li>Qualcomm Snapdragon 675 Processor</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=9&&num=
