  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/product-3.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">HTC 10 - Black</h3>
              <h4>₹8000</h4>
...
<li>Non-removable Li-Ion 3000 mAh battery.Fast battery charging: 50% in 30 min (Quick Charge 3.0)</li></ul></pre>
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=3&&num=
