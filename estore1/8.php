  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/samsung-galaxy-a20s.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Samsung Galaxy A20s</h3>
              <h4>₹12000</h4>
              <pre class="card-text"><ul><li>13+8+5MP triple rear camera with f1.8, 8MP (f2.2) and 5MP (f2.2) | 8MP front camera with f2.0</li>
<li>16.35 centimeters (6.4-inch) HD+ multi-touch capacitive touchscreen with 720 x 1520 pixels resolution | 16M color support</li>
<li>Memory, Storage & SIM: 4GB RAM | 64GB internal memory expandable up to 512GB | Dual SIM (nano+nano) dual-standby (4G+4G)</li>
<li>Android Pie v9.0 operating system with 1.8GHz Qualcomm SDM450-B01 octa core processor</li>
<li>4000mAH lithium-ion battery</li>
<li>Box also includes: Travel adapter, USB cable and user manual</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=8&&num=
