  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <img class="card-img-top w3-animate-zoom" src="images/asus-zenfone-max-m2.png" alt="">
           </div>
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">Asus ZenFone Max M2</h3>
              <h4>₹9499</h4>
<pre class="card-text"><ul><li>
3 GB RAM | 32 GB ROM | Expandable Upto 2 TB </li>
<li>15.9 cm (6.26 inch) HD+ Display</li>
<li>13MP + 2MP | 8MP Front Camera </li>
<li>4000 mAh Battery </li>
<li>Qualcomm Snapdragon 632 Octa Core Processor</li></ul></pre>
               <form method="get">
            ...
            <?php
            $a=$_GET['num'];
            echo ('<a href="http://localhost:8080/estore1/cart.php?id=11&&num=
